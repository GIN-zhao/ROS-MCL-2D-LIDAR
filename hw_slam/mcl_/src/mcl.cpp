/* * @Author: zhaoyu  * @Date: 2024-04-05 16:33:58  * @Last Modified by:   zhaoyu  * @Last Modified time: 2024-04-05 19:33:58  */
#include "mcl.h"
...
mcl::mcl()
{
    ...
    gridMap_ = cv::imread("/home/mywork/ROS-MCL-2D-LIDAR/origin.png", cv::IMREAD_GRAYSCALE);
